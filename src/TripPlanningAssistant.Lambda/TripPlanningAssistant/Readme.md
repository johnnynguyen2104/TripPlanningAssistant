...
WORKDIR /src
COPY ["TripPlanningAssistant.csproj", "TripPlanningAssistant/"]
RUN dotnet restore "TripPlanningAssistant/TripPlanningAssistant.csproj"

WORKDIR "/src/TripPlanningAssistant"
COPY . .
RUN dotnet build "TripPlanningAssistant.csproj" --configuration Release --output /app/build

FROM build AS publish
RUN dotnet publish "TripPlanningAssistant.csproj" \
...
Execute unit tests
```
cd "TripPlanningAssistant/test/TripPlanningAssistant.Tests"
dotnet test
```

Deploy function to AWS Lambda
```
cd "TripPlanningAssistant/src/TripPlanningAssistant"
